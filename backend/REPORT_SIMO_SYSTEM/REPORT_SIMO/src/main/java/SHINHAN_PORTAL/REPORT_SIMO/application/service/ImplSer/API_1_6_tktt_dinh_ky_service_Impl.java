...
@Service("API_1_6_TTDS_TKTT_DK")
public class API_1_6_tktt_dinh_ky_service_Impl implements TemplateDataService<API_1_6_tktt_dinh_ky>,API_1_6_tktt_dinh_ky_service {
    @Autowired
    private API_1_6_tktt_dinh_ky_Repository listFileUploadRepository ;
    @Override
    public List<API_1_6_tktt_dinh_ky> insert(List<API_1_6_tktt_dinh_ky> listData) {
    ...
    // @Override
    //     public
    //     void deleteByTemplateMonthUser(String templateId, String monthYear, String username)
    //     {
    //         listFileUploadRepository.deleteByTemplateIDAndMonthYearAndUsername(templateId, monthYear, username);
    //     }
