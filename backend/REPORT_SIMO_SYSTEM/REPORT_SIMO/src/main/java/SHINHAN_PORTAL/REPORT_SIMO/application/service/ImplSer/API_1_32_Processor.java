...
@Component
public class API_1_32_Processor implements TemplateProcessor {
    @Autowired
    private API_1_32_TT_TNH_NGGL_service service;
    @Autowired
    ...
    public void process(LIST_FILE_UPLOAD fileUpload, List<Map<String, Object>> rawData) {
        ...
        List<API_1_32_TT_TNH_NGGL> formattedData = rawData.stream()
            .map(data -> mapper.mapToAPI_1_32_TT_TNH_NGGL(data, fileUpload.getTemplateID(), fileUpload.getMonthYear(), fileUpload.getUsername()))
