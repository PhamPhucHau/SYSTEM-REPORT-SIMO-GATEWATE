...
public interface API_1_32_TT_TNH_NGGL_service {
    List<API_1_32_TT_TNH_NGGL> insert(List<API_1_32_TT_TNH_NGGL> listData);
    List<API_1_32_TT_TNH_NGGL> getData(String templateID, String monthYear, String status); // Added status
