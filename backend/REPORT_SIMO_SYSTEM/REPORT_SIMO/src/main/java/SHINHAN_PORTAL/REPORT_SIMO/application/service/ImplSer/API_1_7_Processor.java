...
import SHINHAN_PORTAL.REPORT_SIMO.domain.entity.LIST_FILE_UPLOAD;
@Component
public class API_1_7_Processor implements TemplateProcessor {

    @Autowired
    private API_1_7_tktt_nnngl_service service;
    ...
    public void process(LIST_FILE_UPLOAD fileUpload, List<Map<String, Object>> rawData) {
        ...
        List<API_1_7_tktt_nnngl> formattedData = rawData.stream()
            .map(data -> mapper.mapToAPI_1_7_tktt_nnngl(data, fileUpload.getTemplateID(), fileUpload.getMonthYear(), fileUpload.getUsername()))
