...
@Repository
public interface API_1_24_TOCHUC_NGGL_Repository extends MongoRepository<API_1_24_TOCHUC_NGGL, String> {
    List<API_1_24_TOCHUC_NGGL> findByTemplateIDAndMonthYearAndStatus(String templateID, String monthYear, String status);
