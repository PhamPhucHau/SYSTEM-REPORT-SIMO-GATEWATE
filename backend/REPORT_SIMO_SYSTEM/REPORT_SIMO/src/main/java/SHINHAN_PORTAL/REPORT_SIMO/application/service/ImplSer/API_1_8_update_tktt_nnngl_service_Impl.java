...
public class API_1_8_update_tktt_nnngl_service_Impl implements TemplateDataService<API_1_8_update_tktt_nnngl>,API_1_8_update_tktt_nnngl_service {
    ...
    @Override
    public List<API_1_8_update_tktt_nnngl> insert(List<API_1_8_update_tktt_nnngl> listData) {
        return repository.saveAll(listData);
    }

    @Override
    public List<API_1_8_update_tktt_nnngl> getData(String templateID, String monthYear, String status) {
