...
@Component
public class API_1_9_Processor implements TemplateProcessor {

    @Autowired
    private API_1_9_update_tktt_dinh_ky_service service;
    ...
    public void process(LIST_FILE_UPLOAD fileUpload, List<Map<String, Object>> rawData) {
        ...
        List<API_1_9_update_tktt_dinh_ky> formattedData = rawData.stream()
            .map(data -> mapper.mapToAPI_1_9_update_tktt_dinh_ky(data, fileUpload.getTemplateID(), fileUpload.getMonthYear(), fileUpload.getUsername()))
