...
@Component
public class API_1_34_Processor implements TemplateProcessor {
    @Autowired
    private API_1_34_UPDATE_TNH_service service;
    @Autowired
    ...
    public void process(LIST_FILE_UPLOAD fileUpload, List<Map<String, Object>> rawData) {
        ...
        List<API_1_34_UPDATE_TNH> formattedData = rawData.stream()
            .map(data -> mapper.mapToAPI_1_34_UPDATE_TNH(data, fileUpload.getTemplateID(), fileUpload.getMonthYear(), fileUpload.getUsername()))
