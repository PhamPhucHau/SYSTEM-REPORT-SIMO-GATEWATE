...
@Component
public class API_1_30_Processor implements TemplateProcessor {
    @Autowired
    private API_1_30_UPDATE_DVCNTT_service service;
    @Autowired
    ...
    public void process(LIST_FILE_UPLOAD fileUpload, List<Map<String, Object>> rawData) {
        ...
        List<API_1_30_UPDATE_DVCNTT> formattedData = rawData.stream()
            .map(data -> mapper.mapToAPI_1_30_UPDATE_DVCNTT(data, fileUpload.getTemplateID(), fileUpload.getMonthYear(), fileUpload.getUsername()))
