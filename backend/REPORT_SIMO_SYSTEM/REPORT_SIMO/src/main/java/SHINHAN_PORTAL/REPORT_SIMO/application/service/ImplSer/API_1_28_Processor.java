...
@Component
public class API_1_28_Processor implements TemplateProcessor {
    @Autowired
    private API_1_28_TT_DVCNTT_NGGL_service service;
    @Autowired
    ...
    public void process(LIST_FILE_UPLOAD fileUpload, List<Map<String, Object>> rawData) {
        ...
        List<API_1_28_TT_DVCNTT_NGGL> formattedData = rawData.stream()
            .map(data -> mapper.mapToAPI_1_28_TT_DVCNTT_NGGL(data, fileUpload.getTemplateID(), fileUpload.getMonthYear(), fileUpload.getUsername()))
