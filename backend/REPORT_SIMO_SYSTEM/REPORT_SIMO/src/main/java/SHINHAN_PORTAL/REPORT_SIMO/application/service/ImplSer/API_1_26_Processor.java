...
import SHINHAN_PORTAL.REPORT_SIMO.application.service.API_1_26_UPDATE_TOCHUC_service;
...
@Component
public class API_1_26_Processor implements TemplateProcessor {
    @Autowired
    private API_1_26_UPDATE_TOCHUC_service service;
    @Autowired
    ...
    public void process(LIST_FILE_UPLOAD fileUpload, List<Map<String, Object>> rawData) {
        ...
        List<API_1_26_UPDATE_TOCHUC> formattedData = rawData.stream()
            .map(data -> mapper.mapToAPI_1_26_UPDATE_TOCHUC(data, fileUpload.getTemplateID(), fileUpload.getMonthYear(), fileUpload.getUsername()))
