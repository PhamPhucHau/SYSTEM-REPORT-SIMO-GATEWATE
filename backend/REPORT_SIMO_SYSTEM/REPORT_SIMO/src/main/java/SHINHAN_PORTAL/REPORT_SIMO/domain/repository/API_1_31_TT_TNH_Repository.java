...
@Repository
public interface API_1_31_TT_TNH_Repository extends MongoRepository<API_1_31_TT_TNH, String> {
    List<API_1_31_TT_TNH> findByTemplateIDAndMonthYearAndStatus(String templateID, String monthYear, String status);
